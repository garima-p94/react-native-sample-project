 ...
 */
const OFFSET_HEIGHT = Platform.OS !== 'ios' ? 60 : isNotch ? 105 : 80;
  ...
  (
    ...
    const iconView =
      ...
      renderFlashMessageIcon(
        ...
        message.type === 'chat' ? { source: { uri: image } } : null,
      );
...
export default class FlashMessage extends Component {
  static propTypes = {
    ...
    MessageComponent: typeof DefaultFlash,
  ...
  render() {
    ...
    const position = this.prop(message, 'position');
    const image = this.prop(message, 'image');
